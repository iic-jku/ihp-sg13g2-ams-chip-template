...
This step is mainly relevant for advanced designers that want to characterise the analog macro across PVT corners. The following figures show the result of the CACE simulations for 200 iterations.

@fig-inverter-cace-adc-mc and @fig-inverter-cace-adc-mm show the process and mismatch variations of the dc open-loop gain $A_\mathrm{dc,ol}$, while @fig-inverter-cace-adc-vdd plots its variation across several process corners at one fixed supply voltage.

![CACE process variation of $A_\mathrm{dc,ol}$.](fig/inverter_top/Adc_ol_dB_mc.png){#fig-inverter-cace-adc-mc width=70%}

![CACE mismatch variation of $A_\mathrm{dc,ol}$.](fig/inverter_top/Adc_ol_dB_mm.png){#fig-inverter-cace-adc-mm width=70%}

![CACE variation of $A_\mathrm{dc,ol}$ across several process corners.](fig/inverter_top/Adc_ol_dB_vs_vdd.png){#fig-inverter-cace-adc-vdd}

@fig-inverter-cace-fcu-mc and @fig-inverter-cace-fcu-mm show the process and mismatch variations of the open-loop lower cut-off frequency $f_\mathrm{cu}$, while @fig-inverter-cace-fcu-vdd plots its variation across several process corners at one fixed supply voltage.

![CACE process variation of $f_\mathrm{cu}$.](fig/inverter_top/fcu_mc.png){#fig-inverter-cace-fcu-mc width=70%}

![CACE mismatch variation of $f_\mathrm{cu}$.](fig/inverter_top/fcu_mm.png){#fig-inverter-cace-fcu-mm width=70%}

![CACE variation of $f_\mathrm{cu}$ across several process corners.](fig/inverter_top/fcu_vs_vdd.png){#fig-inverter-cace-fcu-vdd}
