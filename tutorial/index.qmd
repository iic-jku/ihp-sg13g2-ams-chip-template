...
::: {.callout-tip}
To run a post-layout simulation, open one of the Xschem testbenches and swap the original symbol with the PEX symbol and include the path to the SPICE netlist to use the extracted netlist in the same testbench. This is the recommended way to compare schematic-only and post-layout simulation results.
:::
