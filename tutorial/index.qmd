...
From these values, the open-loop gain $A_\mathrm{ol}$, the output resistance $R_\mathrm{out}$, the open-loop cut-off frequency $f_\mathrm{cu}$, and the unity-gain frequency $f_\mathrm{T}$ with a dominant capacitive load $C_\mathrm{load} = 10\,\mathrm{pF}$ can be estimated as
...
| :------------------------ | :-------------------------------------: | :---------------------: |
| Open-loop gain $A_\mathrm{ol}$ | $32.72\,\mathrm{dB}$                | $31.33\,\mathrm{dB}$   |
| Dominant pole $f_\mathrm{c}$   | $2.31\,\mathrm{MHz}$                | $2.89\,\mathrm{MHz}$   |
