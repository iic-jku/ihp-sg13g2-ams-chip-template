...
| `make all`          | Full simulation, build, verification, and bondplan generation.                                            |
...
::: {.callout-tip}
The solution to these exercises is available in the [`exercise-solution` branch](https://github.com/iic-jku/ihp-sg13g2-ams-chip-template/tree/exercise-solution) of the repository. It is recommended to try the exercises independently first, and then check the solution for reference and debugging.
:::
