...
set_driving_cell -lib_cell sg13g2_hv_buf_4 -pin {X} -input_transition_rise 0.0000 -input_transition_fall 0.0000 [get_ports {clock_i}]
set_driving_cell -lib_cell sg13g2_hv_buf_4 -pin {X} -input_transition_rise 0.0000 -input_transition_fall 0.0000 [get_ports {enable_i}]
set_driving_cell -lib_cell sg13g2_hv_buf_4 -pin {X} -input_transition_rise 0.0000 -input_transition_fall 0.0000 [get_ports {reset_n_i}]
