...
A names IP block for [Johannes Kepler University Linz](https://www.jku.at/), rendered as a GDSII layout on `Metal5` with `NoMetFiller` for the IHP SG13G2 130 nm CMOS process.
